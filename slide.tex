...
\begin{frame}[plain]
    ...
    \begin{figure}[htpb]
        \begin{center}
            \includegraphics[width=0.2\linewidth]{pic/nankai.jpg}
        \end{center}
    \end{figure}
\end{frame}
...
\begin{frame}{这一份主题与原始的Beamer Theme区别在于}
    \begin{itemize}
        \item 顶栏的小点变成一行而不是多行
        \item 中文采用楷书
...
%           \psRotation{25}(-1.2,2.6){$\dot\psi$}
    ...
    \begin{minipage}{0.5\linewidth}
        ...
        \begin{figure}[h]
            \centering
            \includegraphics[height=.4\textheight]{pic/nankai.jpg}
        \end{figure}
    \end{minipage}
\end{frame}
